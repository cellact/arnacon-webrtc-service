...
const LEGALITY = Object.freeze({
    ...
    [LEG_STATES.CONNECTING]: [I.CONNECT, I.CANCEL],
    [LEG_STATES.CONNECTED]: [I.CONNECT, I.RING],
    [LEG_STATES.CALLING]: [I.RING, I.ACK, I.ANSWER, I.END, I.CANCEL, I.REJECT],
    [LEG_STATES.RINGING]: [I.RING, I.ACK, I.ANSWER, I.END, I.CANCEL, I.REJECT],
